...
class MainApplication(Tk):
    def __init__(self, controller, *args, **kwargs) -> None:
        ...
        self.lang_menu.add_command(label=lng("transl_disclaimer"), state="disabled")
...
class ConnectFrame(LabelFrame):
    ...
    def disconnectCommand(self):
        ...
        self.setNormalState()
        self.parent.showDialog(lng("disconnected"), lng("connection"))
    ...
    def setConnectedState(self, dialog=True):
        ...
        if dialog:
            showinfo(lng("connection"), lng("connected"))
